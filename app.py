...
def predict():
    if request.method=="POST":
        ...
        input_list=[location,minTemp,maxTemp,rainfall,evaporation,sunshine,
        windGustDir,windGustSpeed,winddDir9am,windDir3pm,windspeed9am,windSpeed3pm,humidity9am,
